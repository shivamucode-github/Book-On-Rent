...
@section('main')
    ...
    <section class="flex items-start px-6 gap-6 py-10">
        <section class="{{ $orders != null ? 'w-full' : 'w-3/4' }}">
            @if ($orders->isNotEmpty())
                <div class="flex items-center justify-between border-b border-black pb-3">
                    <h1 class="text-3xl font-semibold">Order Items ({{ count($orders) }})</h1>
        ...
        @if ($orders->isNotEmpty())
            <section class="w-1/4 bg-gray-300 px-4 py-4 rounded-md">
                <h2 class="text-xl font-medium border-b border-black pb-3">Delivery Details</h2>
                <table class="py-2 block" cellpadding="2px">
                    <tr>
                        <td>
                            <span>{{ __('Name') }}</span>
                        </td>
                        ...
                        <td>
                            <address>{{ Auth::user()->name }}</address>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <address>{{ Auth::user()->phone }}</address>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <address>{{ Auth::user()->email }}</address>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <address>{{ now()->format('d-M-Y') }}</address>
                        </td>
                    </tr>
                </table>
            </section>
