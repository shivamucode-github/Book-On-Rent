        ...
        <div class="flex shadow-md my-10">
                ...
                @forelse ($orders as $order)
                    <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                        ...
                        <div class="flex justify-center w-1/5">
                            ...
                            <input class="mx-2 border text-center w-12" type="text" value="{{ $order->quantity }}">
                        ...
                        <span class="text-center w-1/5 font-semibold text-sm">Rs{{ $order->price }}.00</span>
                    </div>
                @empty
            ...
            <div id="summary" class="w-1/4 px-8 py-10">
                ...
                <div class="flex justify-between mt-10 mb-5">
                    ...
                    <span class="font-semibold text-sm">Rs {{ $payments->sum() }}.00</span>
                </div>
                <div>
