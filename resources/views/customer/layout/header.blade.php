<header class="flex gap-12 items-center justify-between border-b border-gray-500 bg-white px-10">
    ...
    <div class="flex items-center gap-6">
        <form action="/books" method="get">
            ...
            <div class="relative">
                <input type="search" value="{{ request('search') }}" name="search" id="search"
                    ...
                    class="outline-none border-2 focus:border-blue-500  border-gray-300 py-2 px-6 pr-10 rounded-full">
                <button type="submit">
                    <svg class="w-6 h-6 absolute text-gray-400 right-2.5 top-2.5" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="relative" x-cloak x-data="{ open: false }">
            ...
            <div x-show="open"
                class="w-36 border border-gray-400 bg-gray-200 absolute top-18 translate-y-4 right-0 z-10">
                <ul class="w-full text-sm space-y-2">
                    {{-- <li><a class="p-2 block hover:bg-gray-300" href="/profile">Edit Profile</a></li> --}}
                    <li><a class="p-2 block hover:bg-gray-300" href="/orders">{{ __('My Orders') }}</a></li>
                    <li><a class="p-2 block hover:bg-gray-300" href="/logout">{{ __('Logout') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
