<x-app-layout>
    ...
    <div class="py-2 ">
        <div class=" max-w-xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="/admin/book/{{ $book->slug }}/update" class="w-full space-y-4" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                        :value="$book->name, old('name')" required autofocus autocomplete="name" />
                ...
                <div class="mt-4">
                    ...
                    <select name="author" id="author" class="py-2 px-3 w-full rounded-md bg-gray-100 border-gray-300">
                        ...
                        <option {{ $book->author->id == $author->id ? 'selected' : '' }} value="{{ $author->id }}">{{ $author->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="flex">
                    ...
                    <div>
                        <img src="{{ asset('storage/'. $book->thumbnail) }}" alt="Image not available" class="w-48 h-48 object-cover">
                    </div>
                </div>
