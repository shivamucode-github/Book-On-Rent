<x-app-layout>
    ...
    <div class="py-2 h-screen">
        <div class=" max-w-xl mx-auto sm:px-6 lg:px-8">
            <form action="/admin/author/{{ $author->slug }}/update" method="POST" class="flex flex-col gap-6">
                @csrf
                <div class="flex flex-col items-start gap-1 text-lg font-base">
                    <label for="name">Author Name</label>
                    <input required type="text" id="name" name="name" value="{{ $author->name, old('name') }}"
