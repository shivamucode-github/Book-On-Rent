                ...
                <div class="flex items-center gap-4" x-cloak
                    ...
                    <div x-show="open"
                        ...
                        <div
                            ...
                            <form action="{{ route('authors.store') }}" method="post" class="flex flex-col gap-6">
                                @csrf
                    ...
                    @forelse ($authors as $key => $author)
                        <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100 text-center">
                            ...
                            <td x-cloak x-data="{ open: false }"
                                ...
                                {{-- component for conformation of deletion of author by admin --}}
                                <div x-show="open"
                                    ...
                                    <div
                                        ...
                                        <p class="text-lg font-medium">Do you really want to delete the author</p>
                                        <div class="flex items-center gap-8 py-6">
                                            <a class="px-6 py-3 bg-red-500 text-white font-medium text-md"
                                                href="/admin/author/{{ $author->slug }}/delete">Yes</a>
