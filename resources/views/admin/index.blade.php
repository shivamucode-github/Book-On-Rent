    ...
    <div class="py-2 h-screen">
        <div class="h-full max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="h-full bg-white overflow-hidden shadow-sm sm:rounded-lg flex gap-6 justify-between p-4">
                <div class="bg-green-400 h-1/4 w-full border border-gray-500 rounded-lg shadow-md shadow-gray-500 p-4 flex flex-col gap-2 justify-center items-center">
                    <span class="text-xl font-semibold">Total Orders</span>
                    <span class="text-6xl font-bold">{{ count($orders) }}</span>
                </div>
                <div class="bg-blue-400 h-1/4 w-full border border-gray-500 rounded-lg shadow-md shadow-gray-500 p-4 flex flex-col gap-2 justify-center items-center">
                    <span class="text-xl font-semibold">Total Users</span>
                    <span class="text-6xl font-bold">{{ count($users) }}</span>
                </div>
                <div class="bg-red-400 h-1/4 w-full border border-gray-500 rounded-lg shadow-md shadow-gray-500 p-4 flex flex-col gap-2 justify-center items-center">
